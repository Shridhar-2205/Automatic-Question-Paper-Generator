 ...
 * @author Dell
 */
public class MarksChoice2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("SEMESTER END (100 MARKS)");
...
if(total==100 && ex.getSelectedItem().equals("OOP"))
{     Statement stmt=null;
...
File fout = new File(filan.getText());
    ...
    try (BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos))) {
       ...
       for (int p=0; p<a5; p++) {
            bw.write((a0+a1+a2+a3+a4+p+1)+". "+que[list.get(p)+30]+" ("+marks[p+30]+")");
            bw.newLine();
            bw.newLine();
            System.out.println(list.get(p));
        }
...
else if(total==100 && ex.getSelectedItem().equals("DS"))
...
else if(total==100 && ex.getSelectedItem().equals("CS"))
{
    Statement stmt=null;
int marks[]=new int[20000];
int i=0,j=1,l=1,m=1,n=1,k;
...
File fout = new File(filan.getText());
    ...
    JOptionPane.showMessageDialog(null,"Not a 100 mark paper");
}
...
ExamType fram8219=new ExamType();
   MarksChoice2.this.setVisible(false);
  ...
  try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarksChoice2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MarksChoice2().setVisible(true);
            }
        });
    }
