...
public class Search1 extends javax.swing.JFrame {
    ...
    private void List1ValueChanged(javax.swing.event.ListSelectionEvent evt) {                                   
        ...
        String password="qa";
         Connection con= DriverManager.getConnection(url,username,password);
        Statement stmt=con.createStatement();
        String Query="SELECT * FROM OOP WHERE QUESTIONS = '"+List1.getSelectedValue()+"'";
        ResultSet rs=stmt.executeQuery(Query);
        DefaultListModel DLM=new DefaultListModel();
        while(rs.next())
        {
...
try{
        ...
        String password="qa";
         Connection con= DriverManager.getConnection(url,username,password);
        Statement stmt=con.createStatement();
String Query="UPDATE OOP SET QUESTIONS='"+NameText.getText()+"' ,MARK='"+IdText.getText()+"' WHERE QUESTIONS='"+List1.getSelectedValue()+"'";
        stmt.execute(Query);
...
try{
        ...
        String password="qa";
         Connection con= DriverManager.getConnection(url,username,password);
        Statement stmt=con.createStatement();
String Query="DELETE FROM OOP WHERE QUESTIONS ='"+List1.getSelectedValue()+"'";
        stmt.execute(Query);
